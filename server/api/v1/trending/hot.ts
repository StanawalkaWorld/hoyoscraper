...
const post_scc = new SSC<Post[]>(60000, async (): Promise<Post[]> => {
    try {
        const endpoint: string =
            "https://bbs-api-os.hoyolab.com/community/post/wapi/post/list?loading_type=0&page_size=30&reload_times=0&type=1";
        ...
        data.data.list.forEach((post_record) => {
            result.push({
                ...
                created_at: post_record.post.created_at * 1000,
